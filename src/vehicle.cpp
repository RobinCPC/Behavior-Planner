...
vector<Vehicle> Vehicle::choose_next_state(map<int, vector<Vehicle>> predictions) {
  ...
  vector<string> pos_next_states = successor_states();
  ...
  for(vector<string>::iterator it = pos_next_states.begin(); it != pos_next_states.end(); ++it)
  {
    // generate a rough idea of what trajectory we would follow IF we 
    // chose this state
